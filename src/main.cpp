...
int64 nChainStartTime = 1499741374;
...
const string strMessageMagic = "enjoyunionchain Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    else if(nHeight > 100 && nHeight <= 99999999)
    {
        nSubsidy = 0.0 * COIN;
    }
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    if(nHeight < YEARLY_BLOCKCOUNT)
            ...
            nRewardCoinYear = 1.25 * MAX_MINT_PROOF_OF_STAKE;
        else if(nHeight >= (3 * YEARLY_BLOCKCOUNT))
            nRewardCoinYear = 1 * MAX_MINT_PROOF_OF_STAKE;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in enjoyunionchain
    bool fStrictPayToScriptHash = true; // Always active in enjoyunionchain
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "enjoyunionchain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector enjoyunionchain empty mapBlockIndex enjoyunionchain enjoyunionchain";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0xd4e56e51a112fb859978cb7514030f076fd3cad721308fc76de702641d4993fe"));
